...
def main():
    ...
    CONFIG = {
        "model": "descentvortex",   # Change name when using a different model
    ...
    transform_train = transforms.Compose([
        transforms.RandomCrop(40, padding=4), #random crops of 40x40 with padding
